...
def main():
    ...
    for i in range(args.count):
        ...
        if(len(random_str) == 5):
            random_str = random_str.ljust(1)
        if(len(random_str) == 4):
            random_str = random_str.ljust(2)
        if(len(random_str) < 3):
            random_str = random_str.ljust(3)
        if(len(random_str) < 2):
            random_str = random_str.ljust(4)
        if(len(random_str) < 1):
            random_str = random_str.ljust(5)
        image = numpy.array(captcha_generator.generate_image(random_str))
        random_str = random_str.replace("/", "D")
        random_str = random_str.replace("_", "E")
